...
var map = new ol.Map({
    ...
    view: new ol.View({
         maxZoom: 28, minZoom: 1, projection: new ol.proj.Projection({
            code: 'EPSG:3857',
            //extent: [3106389.129592, -211657.403493, 3176884.828620, -152148.240860],
            units: 'm'})
    })
});

//initial view - epsg:3857 coordinates if not "Match project CRS"
map.getView().fit([3101076.786680, -213145.132558, 3182197.171532, -150660.511794], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">INITIATIVE DES FORETS COMMUNAUTAIRES - TERRITOIRE DE WALIKALE</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (171 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Ce projet represente les etendues  d\'Initiatives de forets communautaires des communautes accompagnees par le PIDP dans le territoire de WALIKALE en Province du NORD-KIVU.';
            }
